...
window.onload = function() {
  ...
  var getCurrentTime = function() {
    ...
    if (current >= 5 && current < 19) return 'Que tengas un bonito día ~ JM.';
    if (current >= 19 && current < 22) return 'Que tengas buenas tardes ~ JM.';
    if (current >= 22 || current < 5) return 'Que tengas buenas noches ~ JM.';
  }

  var messages = [
    '...😶‍🌫️...',
    'Hola a todos 👋',
    'Soy Juan Manuel, JuanMa para los amigos',
